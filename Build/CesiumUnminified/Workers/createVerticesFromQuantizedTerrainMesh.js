 ...
 */
define(['./defined-b9ff0e39', './Check-e6691f86', './freezeObject-2d5b18ce', './defaultValue-199f5aa8', './Math-2145e044', './Cartesian2-40ed5530', './defineProperties-ae15c9d5', './Transforms-94513c2d', './RuntimeError-d5522ee3', './WebGLConstants-554ddbe2', './ComponentDatatype-9477db2c', './when-c208a7cf', './AttributeCompression-a7396e6f', './IndexDatatype-668aa2f9', './IntersectionTests-f6d27a39', './Plane-297770b0', './WebMercatorProjection-a290a2f5', './createTaskProcessorWorker', './EllipsoidTangentPlane-1ba7ce65', './OrientedBoundingBox-d258fabd', './TerrainEncoding-b01d1123'], function (defined, Check, freezeObject, defaultValue, _Math, Cartesian2, defineProperties, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, when, AttributeCompression, IndexDatatype, IntersectionTests, Plane, WebMercatorProjection, createTaskProcessorWorker, EllipsoidTangentPlane, OrientedBoundingBox, TerrainEncoding) { 'use strict';
