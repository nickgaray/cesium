 ...
 */
define(['./defined-b9ff0e39', './Check-e6691f86', './freezeObject-2d5b18ce', './defaultValue-199f5aa8', './Math-2145e044', './RuntimeError-d5522ee3', './WebGLConstants-554ddbe2', './ComponentDatatype-9477db2c', './when-c208a7cf', './IndexDatatype-668aa2f9', './createTaskProcessorWorker'], function (defined, Check, freezeObject, defaultValue, _Math, RuntimeError, WebGLConstants, ComponentDatatype, when, IndexDatatype, createTaskProcessorWorker) { 'use strict';
