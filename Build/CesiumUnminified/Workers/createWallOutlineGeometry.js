 ...
 */
define(['./defined-b9ff0e39', './Check-e6691f86', './freezeObject-2d5b18ce', './defaultValue-199f5aa8', './Math-2145e044', './Cartesian2-40ed5530', './defineProperties-ae15c9d5', './Transforms-94513c2d', './RuntimeError-d5522ee3', './WebGLConstants-554ddbe2', './ComponentDatatype-9477db2c', './GeometryAttribute-4754007e', './when-c208a7cf', './GeometryAttributes-c3465b51', './IndexDatatype-668aa2f9', './IntersectionTests-f6d27a39', './Plane-297770b0', './EllipsoidTangentPlane-1ba7ce65', './EllipsoidRhumbLine-d5ed1c3f', './PolygonPipeline-eaa2424e', './EllipsoidGeodesic-b257688e', './PolylinePipeline-5ad419cb', './WallGeometryLibrary-c3ece839'], function (defined, Check, freezeObject, defaultValue, _Math, Cartesian2, defineProperties, Transforms, RuntimeError, WebGLConstants, ComponentDatatype, GeometryAttribute, when, GeometryAttributes, IndexDatatype, IntersectionTests, Plane, EllipsoidTangentPlane, EllipsoidRhumbLine, PolygonPipeline, EllipsoidGeodesic, PolylinePipeline, WallGeometryLibrary) { 'use strict';
